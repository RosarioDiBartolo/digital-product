...
export type ProductVariant = {
  ...
  digital_product_link: Maybe<LinkDigitalProductModuleDigitalProductProductProductVariant>;
...
export type Order = {
  ...
  region: Maybe<Region>;
  sales_channel: Maybe<SalesChannel>;
  digital_product_order_link: Maybe<LinkDigitalProductModuleDigitalProductOrderOrderOrder>;
...
export type DigitalProduct = {
  ...
  id: Scalars['ID']['output'];
  name: Scalars['String']['output'];
  medias: Array<Maybe<DigitalProductMedia>>;
  orders: Array<Maybe<DigitalProductOrder>>;
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
  product_variant_link: Maybe<LinkDigitalProductModuleDigitalProductProductProductVariant>;
  product_variant: Maybe<ProductVariant>;
};

export enum DigitalProductMediaTypeEnum {
  Main = 'MAIN',
  Preview = 'PREVIEW'
}

export type DigitalProductMedia = {
  __typename?: 'DigitalProductMedia';
  id: Scalars['ID']['output'];
  type: DigitalProductMediaTypeEnum;
...
export enum DigitalProductOrderStatusEnum {
  Pending = 'PENDING',
  Sent = 'SENT'
}

export type DigitalProductOrder = {
  __typename?: 'DigitalProductOrder';
  id: Scalars['ID']['output'];
  status: DigitalProductOrderStatusEnum;
  products: Array<Maybe<DigitalProduct>>;
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
  order_link: Maybe<LinkDigitalProductModuleDigitalProductOrderOrderOrder>;
  order: Maybe<Order>;
};
...
export type LinkDigitalProductModuleDigitalProductOrderOrderOrder = {
  __typename?: 'LinkDigitalProductModuleDigitalProductOrderOrderOrder';
  digital_product_order_id: Scalars['String']['output'];
  order_id: Scalars['String']['output'];
  order: Maybe<Order>;
  createdAt: Scalars['String']['output'];
  updatedAt: Scalars['String']['output'];
...
export type LinkDigitalProductModuleDigitalProductProductProductVariant = {
  __typename?: 'LinkDigitalProductModuleDigitalProductProductProductVariant';
  digital_product_id: Scalars['String']['output'];
...
declare module '@medusajs/framework/types' {
  interface RemoteQueryEntryPoints {
    ...
    digital_product_media: DigitalProductMedia
    ...
    digital_product_order_order: LinkDigitalProductModuleDigitalProductOrderOrderOrder
    digital_product_product_variant: LinkDigitalProductModuleDigitalProductProductProductVariant
  }
}